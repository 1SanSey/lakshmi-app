...
export default function CostsNew() {
  ...
  const [selectedCostItems, setSelectedCostItems] = useState<(CostItem & { nomenclatureName?: string })[]>([]);
  ...
  // Форма для создания/редактирования расхода
